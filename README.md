...
This repository aims to introduce and make publicly a recent proposed methodology for blink detection and classification. For more details, you can see in
...
A short demo is provided where a sample image (close distance face image) is used to segment each area of eye in two categories, iris and sclera (or eyelids).
